...
char INDEX_PAGE[] = "<!DOCTYPE html>\n"
                    "<html>\n"
                    "<head>\n"
                    "    <title>Welcome to QSJ WebServer!</title>\n"
                    "    <style>\n"
                    "        body {\n"
                    "            width: 35em;\n"
                    "            margin: 0 auto;\n"
                    ...
                    "</head>\n"
                    "<body>\n"
                    "<h1>Welcome to QSJ WebServer!</h1>\n"
                    "<p>If you see this page, the qsj webserver is successfully installed and\n"
                    "    working. </p>\n"
                    "\n"
                    "<p>For online documentation and support please refer to\n"
                    "    <a href=\"https://github.com/tigersniffsrose5\">tigersniffsrose5</a>.<br/>\n"
                    "\n"
                    "<p><em>Thank you for using qsj WebServer.</em></p>\n"
                    "</body>\n"
                    "</html>";
